...
<div className="mb-6 flex flex-col gap-1">
  <p className="text-sm font-medium text-gray-700">Days to Cheat Day</p>
  ...
  onClick={() => {
    if (daysUntilCheatDay < 7) {
      ...
      updateCheatDay(newVal); // update and save
    }
  }}
  className="w-7 h-7 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center text-lg"
>
  +
</button>
  </div>
